  ...
  const isActive = (path: string) => {
    ...
    if (path === "/clientes") {
      return (
        ...
        (!location.search || location.search === "?tab=lista")
      );
    }

    if (path === "/nlp") {
      return (
        location.pathname === "/nlp" &&
        (!location.search || location.search === "?tab=analizar")
      );
    }
    ...
    <div style={containerStyle}>
      ...
      <aside style={sidebarStyle}>
        ...
        <nav style={navContainerStyle}>
          ...
          <div>
            <div
              style={parentItemStyle(location.pathname.startsWith("/clientes"))}
            ...
            {openSections.clientes && (
              <div style={subMenuContainerStyle}>
                <Link
                  to="/clientes?tab=lista"
                  style={subItemStyle(isActive("/clientes"))}
                >
                  Lista de clientes
                </Link>
                <Link
                  to="/clientes?tab=nuevo"
                  style={subItemStyle(isActive("/clientes?tab=nuevo"))}
                >
                  Nuevo cliente
                </Link>
                <Link
                  to="/clientes?tab=historial"
                  style={subItemStyle(isActive("/clientes?tab=historial"))}
                >
                  Historial
                </Link>
              </div>
          ...
          <div>
            ...
            {openSections.atencion && (
              <div style={subMenuContainerStyle}>
                ...
                <Link
                  to="/comentarios"
                  style={subItemStyle(isActive("/comentarios"))}
                >
                  Comentarios
                </Link>
          ...
          <div>
            <div
              style={parentItemStyle(location.pathname.startsWith("/nlp"))}
            ...
            {openSections.nlp && (
              <div style={subMenuContainerStyle}>
                <Link
                  to="/nlp?tab=analizar"
                  style={subItemStyle(
                    isActive("/nlp") || isActive("/nlp?tab=analizar"),
                  )}
                >
                  Analizar comentario
                </Link>
                <Link
                  to="/nlp?tab=palabras"
                  style={subItemStyle(isActive("/nlp?tab=palabras"))}
                >
                  Palabras frecuentes
                </Link>
                <Link
                  to="/nlp?tab=categorias"
                  style={subItemStyle(isActive("/nlp?tab=categorias"))}
                >
                  Categorías
                </Link>
                <Link
                  to="/nlp?tab=clasificacion"
                  style={subItemStyle(isActive("/nlp?tab=clasificacion"))}
                >
                  Clasificación
                </Link>
              </div>
          ...
          <div>
            <div
              style={parentItemStyle(location.pathname.startsWith("/metricas"))}
              onClick={() => toggleSection("scipy")}
            >
              <div
                style={{ display: "flex", alignItems: "center", gap: "10px" }}
              >
            ...
            {openSections.scipy && (
              <div style={subMenuContainerStyle}>
                <Link
                  to="/metricas"
                  style={subItemStyle(isActive("/metricas"))}
                >
                  Estadísticas (SciPy)
                </Link>
          ...
          <div>
            <div
              style={parentItemStyle(location.pathname.startsWith("/reportes"))}
            ...
            {openSections.reportes && (
              <div style={subMenuContainerStyle}>
                <Link
                  to="/reportes/atencion"
                  style={subItemStyle(isActive("/reportes/atencion"))}
                >
                  Atención
                </Link>
                <Link
                  to="/reportes/nlp"
                  style={subItemStyle(isActive("/reportes/nlp"))}
                >
                  NLP
                </Link>
                <Link
                  to="/reportes/estadisticas"
                  style={subItemStyle(isActive("/reportes/estadisticas"))}
                >
                  Estadísticas
                </Link>
              </div>
      ...
      <div style={mainContentWrapperStyle}>
        ...
        <header style={headerStyle}>
          <div style={searchBarContainerStyle}>
            ...
            <input
              type="text"
              placeholder="Buscar analíticas, clientes..."
